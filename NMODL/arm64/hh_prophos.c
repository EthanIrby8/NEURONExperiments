...
#define nrn_init _nrn_init__hh_prophos
#define _nrn_initial _nrn_initial__hh_prophos
#define nrn_cur _nrn_cur__hh_prophos
#define _nrn_current _nrn_current__hh_prophos
#define nrn_jacob _nrn_jacob__hh_prophos
#define nrn_state _nrn_state__hh_prophos
#define _net_receive _net_receive__hh_prophos 
#define _f_rates _f_rates__hh_prophos 
#define rates rates__hh_prophos 
#define states states__hh_prophos 
...
#define receptor_activation	*_ppvar[6]._pval
#define _p_receptor_activation	_ppvar[6]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hh_prophos", _hoc_setdata,
 "rates_hh_prophos", _hoc_rates,
 "vtrap_hh_prophos", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hh_prophos
...
#define _gth 0
#define htau_hh_prophos _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hh_prophos _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hh_prophos _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hh_prophos _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hh_prophos _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hh_prophos _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hh_prophos
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_hh_prophos", 0, 1e+09,
 "gkbar_hh_prophos", 0, 1e+09,
 "gnabar_hh_prophos", 0, 1e+09,
 "usetable_hh_prophos", 0, 1,
 0,0,0
};
 ...
 "htau_hh_prophos", "ms",
 "ntau_hh_prophos", "ms",
 "gnabar_hh_prophos", "S/cm2",
 "gkbar_hh_prophos", "S/cm2",
 "gl_hh_prophos", "S/cm2",
 "el_hh_prophos", "mV",
 "gna_hh_prophos", "S/cm2",
 "gk_hh_prophos", "S/cm2",
 "il_hh_prophos", "mA/cm2",
 "receptor_activation_hh_prophos", "1",
 0,0
};
 ...
 "minf_hh_prophos", &minf_hh_prophos,
 "hinf_hh_prophos", &hinf_hh_prophos,
 "ninf_hh_prophos", &ninf_hh_prophos,
 "mtau_hh_prophos", &mtau_hh_prophos,
 "htau_hh_prophos", &htau_hh_prophos,
 "ntau_hh_prophos", &ntau_hh_prophos,
 "usetable_hh_prophos", &usetable_hh_prophos,
 0,0
};
...
"hh_prophos",
 ...
 "n_hh_prophos",
 0,
 "receptor_activation_hh_prophos",
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "cvodeieq");
 	...
 	ivoc_help("help ?1 hh_prophos /Users/Ethan/Documents/Documents/GithubRepos/NEURONExperiments/NMODL/hh_prophos.mod\n");
...
static int _reset;
static char *modelname = "hh_prophos.mod   squid sodium, potassium, and leak channels";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gna = gnabar * m * m * m * h ;
   ina = gna * ( v - ena ) ;
   gk = ( 1.0 + receptor_activation ) * gkbar * n * n * n * n ;
   ik = gk * ( v - ek ) ;
   il = gl * ( v - el ) ;
   }
 _current += ina;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/Ethan/Documents/Documents/GithubRepos/NEURONExperiments/NMODL/hh_prophos.mod";
static const char* nmodl_file_text = 
  "TITLE hh_prophos.mod   squid sodium, potassium, and leak channels\n"
  " \n"
  "COMMENT\n"
  ...
  "        gna = gnabar*m*m*m*h\n"
  "	ina = gna*(v - ena)\n"
  "        gk = (1+receptor_activation)*gkbar*n*n*n*n\n"
  "	ik = gk*(v - ek)      \n"
  "        il = gl*(v - el)\n"
  "}\n"
  " \n"
