...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _NMDA_Channel_Calcium_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NMDA_Channel_Calcium /Users/Ethan/Documents/Documents/GithubRepos/NEURONExperiments/NMODL/NMDA_Channel_Calcium.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double FARADAY = 96485.3;
static int _reset;
static char *modelname = "NMDA Receptor with Calcium Dynamics";
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 40 in file NMDA_Channel_Calcium.mod:\n    : Calculate Mg2+ block\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/Ethan/Documents/Documents/GithubRepos/NEURONExperiments/NMODL/NMDA_Channel_Calcium.mod";
static const char* nmodl_file_text = 
